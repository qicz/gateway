...
// GatewayProvider defines the desired configuration of a provider.
// +union
type GatewayProvider struct {
	...
	//
	// +optional
	Kubernetes *GatewayKubernetesProvider `json:"kubernetes,omitempty"`
	...
	//
	// +optional
	File *GatewayFileProvider `json:"file,omitempty"`
}

// GatewayKubernetesProvider defines configuration for the Kubernetes provider.
type GatewayKubernetesProvider struct {
...
// GatewayFileProvider defines configuration for the File provider.
type GatewayFileProvider struct {
